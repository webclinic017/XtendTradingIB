...
13.	I have already tried SELL order too.. the functionality of BUY and SELL already completed. For now I am currently working on the webservice.. this is just the demo to show the progress of application..
